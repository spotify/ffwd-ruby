...
public class ChannelUtils {
    ...
    private void tryAction(final ChannelAction action, final int attempt, final ResolvableFuture<ChannelFuture> handle, final AtomicReference<Timeout> currentTimeout) {
