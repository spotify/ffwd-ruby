require 'evd/update_target'

describe EVD::UpdateTarget do
  let(:base_array){[:bar]}
  ...
  let(:update_array){
    EVD::UpdateTarget.new(base_array, target, limit, oper_array)
  }

  let(:update_hash){
    EVD::UpdateTarget.new(base_hash, target, limit, oper_hash)
  }
